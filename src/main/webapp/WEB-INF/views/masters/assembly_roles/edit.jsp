...
<html>
<head>
	<title><spring:message code="assemblyroles.edit.title" text="Edit Role"/></title>
...
<form:form cssClass="wufoo" action="assembly_roles" method="PUT" 
	...
	<div class="info">
		<h2><spring:message code="assemblyroles.edit.heading" text="Details"/> [Id:${assemblyRole.id}]</h2>
	...
	<li>
	<label class="desc"><spring:message code="assemblyroles.name" text="Name"/>&nbsp;*</label>
		<div>
