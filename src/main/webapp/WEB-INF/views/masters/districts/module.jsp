...
<html>
<head>
	<title><spring:message code="district.list" text="List of Districts"/></title>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','districts/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','districts/new')	;
		}
		...
		function editRecord() {
			...
			showTabByIdAndUrl('details_tab','districts/'+row+'/edit');
		}
		...
		function deleteRecord() {
			...
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('districts/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'districts/'+rowid+'/edit');
		}
	</script>
</head>
<body>
