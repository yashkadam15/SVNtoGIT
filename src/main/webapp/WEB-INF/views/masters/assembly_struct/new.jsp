...
<html>
<head>
	<title><spring:message code="assemblystruct.new.title" text="Add Assembly Structure"/></title>
...
<form:form cssClass="wufoo" action="assembly_struct" method="POST" 
	...
	<div class="info">
		<h2><spring:message code="assemblystruct.new.heading" text="Enter Details"/></h2>
