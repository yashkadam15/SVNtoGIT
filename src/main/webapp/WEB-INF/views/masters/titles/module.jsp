...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','titles/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','titles/new')	;
		}
		...
		function editRecord() {
			...
			showTabByIdAndUrl('details_tab','titles/'+row+'/edit');
		}
		...
		function deleteRecord() {
			...
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('titles/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'titles/'+rowid+'/edit');
		}
	</script>
</head>
<body>
