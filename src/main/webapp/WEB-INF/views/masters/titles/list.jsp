...
<body>
	...
	<div class="commandbar">
				<div class="commandbarContent">
					<a href="titles/new" id="new_record"><spring:message code="generic.new" text="New"/></a>  |
					<a href="titles" id="delete_record"><spring:message code="generic.delete" text="Delete"/></a> |
				</div>
	</div>
