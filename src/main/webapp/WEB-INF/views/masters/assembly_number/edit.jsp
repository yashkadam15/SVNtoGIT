...
<html>
<head>
	<title><spring:message code="assemblynumber.edit.title" text="Edit Assembly Number"/></title>
...
<form:form cssClass="wufoo" action="assembly_number" method="PUT" 
	...
	<div class="info">
		<h2><spring:message code="assemblynumber.edit.heading" text="Details"/> [Id:${assemblyNumber.id}]</h2>
