...
<html>
<head>
	<title><spring:message code="state.list" text="List of States"/></title>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','states/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','states/new')	;
		}
		...
		function editRecord() {
			...
			showTabByIdAndUrl('details_tab','states/'+row+'/edit');
		}
		...
		function deleteRecord() {
			...
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('states/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'states/'+rowid+'/edit');
		}
	</script>
</head>
<body>
