...
<html>
<head>
	<title><spring:message code="assembly_term.edit.title" text="Edit Assembly Term"/></title>
...
<form:form cssClass="wufoo" action="assembly_terms" method="PUT" 
	...
	<div class="info">
		<h2><spring:message code="assembly_term.edit.heading" text="Details"/>[Id:${assemblyTerm.id}]</h2>
