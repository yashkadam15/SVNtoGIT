...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','tehsils/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','tehsils/new')	;
		}
		...
		function editRecord() {
			...
			showTabByIdAndUrl('details_tab','tehsils/'+row+'/edit');
		}
		...
		function deleteRecord() {
			...
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('tehsils/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'tehsils/'+rowid+'/edit');
		}
	</script>
</head>
<body>
