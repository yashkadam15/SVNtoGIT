...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','messages/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','messages/new')	;
		}
		...
		function editRecord() {
			...
			showTabByIdAndUrl('details_tab','messages/'+row+'/edit');
		}
		...
		function deleteRecord() {
			...
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('messages/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'messages/'+rowid+'/edit');
		}
	</script>
</head>
<body>
